...
public class AlumnoPart2 {
	...
	public AlumnoPart2(String nombre, String apellido, LocalDate fechaNacimiento) {
		this.nombre = nombre;
	...
	public static void main(String[] args) {
		AlumnoPart2 grupo[] = new AlumnoPart2[5];
		AlumnoPart2 alumno1 = new AlumnoPart2();
		AlumnoPart2 alumno2 = new AlumnoPart2();
		AlumnoPart2 alumno3 = new AlumnoPart2();
		AlumnoPart2 alumno4 = new AlumnoPart2();
		AlumnoPart2 alumno5 = new AlumnoPart2();
	...
	public static void ingresarDatos(AlumnoPart2 vector[]) {
	...
	public static void printArray(AlumnoPart2 vector []) {
		for (int i = 0; i < vector.length; i++) {
